/**
 * MediLink UI primitives - provider workspace.
 *
 * A copy of web-patient/src/ui/index.tsx. Copied rather than shared through a
 * workspace package on purpose: two Vite apps, no monorepo tooling, and a
 * package would add a build step to save fifteen lines of import path. If a
 * third surface appears (the admin portal in R7), promote it then.
 *
 ...
 * bundle than the primitives this product actually needs.
 */
